...
$(function () {
	(function (window) {
		...
		function setHtmlInfo(postInfo) {
			...
			$("#companyAndPost").html(((!!postInfo.Position) ? postInfo.Position : "") + "&nbsp;&nbsp;" + postInfo.Company);
		...
		function getCompanyInfoHtml(postInfo) {
			var html = '';
			html += ''
				+ '<div class="info"><span>性质</span>' + ((!!postInfo.Nature) ? postInfo.Nature : "") + '</div>'
				+ '<div class="info"><span>行业</span>' + ((!!postInfo.Trade) ? postInfo.Trade : "") + '</div>'
				+ '<div class="info"><span>规模</span>' + ((!!postInfo.Scale) ? postInfo.Scale : "") + '</div>'
				+ '<div class="info"><span>地点</span>' + ((!!postInfo.Address) ? postInfo.Address : "") + '</div>';
			return html;
		}

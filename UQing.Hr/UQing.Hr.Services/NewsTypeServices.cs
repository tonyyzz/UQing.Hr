...
namespace UQing.Hr.Services
{
    ...
    /// 负责每个数据表的业务逻辑操作
    /// </summary>
    public partial class NewsTypeServices : BaseServices<NewsType>, INewsTypeServices
    {
        private INewsTypeRepository _dal;
    
        #region 定义构造函数接收AutoFac将数据仓储层的具体实现类的对象注入到此类中
        public NewsTypeServices(INewsTypeRepository dal)
        {
            base._baseDal = dal;
            this._dal = dal;
        }

...
namespace UQing.Hr.Services
{
    ...
    /// 负责每个数据表的业务逻辑操作
    /// </summary>
    public partial class FeedBackServices : BaseServices<FeedBack>, IFeedBackServices
    {
        private IFeedBackRepository _dal;
    
        #region 定义构造函数接收AutoFac将数据仓储层的具体实现类的对象注入到此类中
        public FeedBackServices(IFeedBackRepository dal)
        {
            base._baseDal = dal;
            this._dal = dal;
        }

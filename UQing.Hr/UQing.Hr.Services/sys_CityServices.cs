...
namespace UQing.Hr.Services
{
    ...
    /// 负责每个数据表的业务逻辑操作
    /// </summary>
    public partial class sys_CityServices : BaseServices<sys_City>, Isys_CityServices
    {
        private Isys_CityRepository _dal;
    
        #region 定义构造函数接收AutoFac将数据仓储层的具体实现类的对象注入到此类中
        public sys_CityServices(Isys_CityRepository dal)
        {
            base._baseDal = dal;
            this._dal = dal;
        }

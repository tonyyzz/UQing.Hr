...
namespace UQing.Hr.Services
{
    ...
    /// 负责每个数据表的业务逻辑操作
    /// </summary>
    public partial class Sys_LogsServices : BaseServices<Sys_Logs>, ISys_LogsServices
    {
        private ISys_LogsRepository _dal;
    
        #region 定义构造函数接收AutoFac将数据仓储层的具体实现类的对象注入到此类中
        public Sys_LogsServices(ISys_LogsRepository dal)
        {
            base._baseDal = dal;
            this._dal = dal;
        }
